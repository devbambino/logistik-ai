...
class ManagerAgent:
    ...
    def _create_agent(self) -> AgentExecutor:
        ...
        prompt = PromptTemplate.from_template(
            """You are an AI assistant for logistics managers using a logistics management system.
            ...
            Think about how to best help the manager. You have access to the following tools:
