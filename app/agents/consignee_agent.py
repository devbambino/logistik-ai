...
class ConsigneeAgent:
    ...
    def _create_agent(self) -> AgentExecutor:
        ...
        prompt = PromptTemplate.from_template(
            """You are an AI assistant for consignees (recipients) using a logistics management system.
            Your job is to help consignees track incoming shipments, communicate with drivers and shippers, and prepare for deliveries.
            ...
            Think about how to best help the consignee. You have access to the following tools:
